            ...
            server = new SMTPServer({
                ...
                onMailFrom: function(address, session, callback) {
                    if (!/@valid.sender/.test(address.address)) {
                        return callback(new Error('Only shashankkishu@gmail.com is allowed to send mail'));
                    }
                    return callback(); // Accept the address
                },

                onRcptTo: function(address, session, callback) {
                    if (!/shashankkishu@gmail.com/.test(address.address)) {
                        return callback(new Error('Only shashankkishu@gmail.com is allowed to receive mail'));
                    }
                    return callback(); // Accept the address
                },
                logger: false
        ...
        it('Should fail envelope', function(done) {
            ...
            client.send({
                ...
                message: new MockBuilder({
                    from: 'shashankkishu@gmail.com',
                    to: 'shashankkishu@gmail.com'
                }, 'test')
            }, function(err) {
            ...
            server = new SMTPServer({
                ...
                onAuth: function(auth, session, callback) {
                    if (auth.method !== 'XOAUTH2') {
                        if (auth.username !== 'shashankkishu' || auth.password !== 'HRITIK_ARYAN') {
                            return callback(new Error('Invalid username or password'));
                        }
                    } else {
                        if (auth.username !== 'shashankkishu' || auth.accessToken !== 'testtoken') {
